...
export const createLoteSchema = z
    .object({
        ...
        nombre_lote: z.string({ error: 'Nombre de lote requerido' }).min(1, 'El nombre del lote es requerido').toUpperCase(),
...
export type CreateLoteSchema = z.infer<typeof createLoteSchema>
